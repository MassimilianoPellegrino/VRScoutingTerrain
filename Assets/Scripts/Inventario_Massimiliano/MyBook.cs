...
public class MyBook : MonoBehaviour {
    ...
    public void UpdateBook()
    {
        ...
        if (mode == MyFlipMode.RightToLeft)
    ...
    public void ReleasePage()
    {
        if (pageDragging)
        {
            ...
            if (distanceToRight < distanceToLeft && mode == MyFlipMode.RightToLeft)
                TweenBack();
            else if (distanceToRight > distanceToLeft && mode == MyFlipMode.LeftToRight)
                TweenBack();
            else
                TweenForward();
        }
